...
QString OpenaiManager::sendMessage(const QString& url, 
                                 const QString& apiKey,
                                 const QString& model,
                                 const QString& prompt,
                                 const QVector<QString>& userPrompts,
...
bool OpenaiManager::testApi(const QString& url, 
                          const QString& apiKey,
                          const QString& model)
{
    try {
...
QString OpenaiManager::sendRequest(const QString& jsonData, 
                                 const QString& url, 
                                 const QString& apiKey)
{ 
